...
public abstract class ClientState implements Focusable {
  ...
  public enum ClientStateType {
    LOADING_GAME, MAIN_MENU, OPTIONS_MENU, CREATE_LAN_GAME_MENU, JOIN_LAN_GAME_MENU, FIND_GAME_ONLINE_MENU, MATCH_INIT, JOINING_MATCH_STATE, ROUND_INIT, ROUND_START, ROUND, ROUND_END, LEAVING_MATCH, MATCH_END, EXIT_GAME
  }
