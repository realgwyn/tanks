package io.game.tanks.server.cfg;
...
import io.game.tanks.server.core.Server;
...
public class ServerConfig {
  ...
  //TODO: Server should run as separate jvm process (server should have higher cpu priority than client)
  @Bean
  ...
  public LocalSessionFactoryBean sessionFactory() {
    ...
    sessionFactory.setPackagesToScan(new String[] { "io.game.tanks.database.domain" });
