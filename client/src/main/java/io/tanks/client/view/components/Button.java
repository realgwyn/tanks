...
public class Button extends GuiComponent {
  ...
  private io.tanks.client.view.components.Label label;
  private boolean borderEnabled = true;

  public Button(String text, Color color) {
    this(new io.tanks.client.view.components.Label(text, color), color, DEFAULT_WIDTH, DEFAULT_HEIGHT);
  }

  public Button(String text, Font font) {
    this(new io.tanks.client.view.components.Label(text, font), GameStyle.WHITE, DEFAULT_WIDTH, DEFAULT_HEIGHT);
  }
